...
function displayInventory() {
    ...
    connection.query(queryStore, function (err, data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            storeOut += "Quantity: " + data[i].stock_quantity + "\n";
        ...
        inquirer.prompt([{
            ...
            connection.query(queryStore, {
                ...
                if (data.length === 0) {
                    ...
                    var updateQueryStore = "UPDATE products SET stock_quantity = " + (productData.stock_quantity + addQuantity) + " WHERE item_id = " + item;
